...
Template::Template() : timer(nullptr) {
}
...
void Template::AttachEvent(lv_obj_t* obj, lv_event_code_t code) {
...
void Template::Update() {
    lv_label_set_text_fmt(View.ui.labelTick, "tick = %d save = %d",
                          Model.GetData(), Model.TickSave);
}
