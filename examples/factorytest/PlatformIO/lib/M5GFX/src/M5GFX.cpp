...
// ESP_LOGI("DEBUG","AXP0x03 :%02x ", lgfx::i2c::readRegister8(i2c_port, axp_i2c_addr, 0x03, 400000).value());
        ...
        if (chk_axp.has_value() && chk_axp.value() == 0x4A)
        {
          ...
          if (chk_aw .has_value() && chk_aw .value() == 0x23)
          {
            ...
            m5gfx::i2c::writeRegister8(i2c_port, aw9523_i2c_addr, 0x7F, 0x00);
            vTaskDelay(50);
            m5gfx::i2c::readRegister8(i2c_port, aw9523_i2c_addr, 0x00, 0b00011000);  // Clear interrupt?
            m5gfx::i2c::readRegister8(i2c_port, aw9523_i2c_addr, 0x01, 0b00011000);  // Clear interrupt?
            m5gfx::i2c::writeRegister8(i2c_port, aw9523_i2c_addr, 0x04, 0b00011000);  // CONFIG_P0 OUT[0]/IN[1]
            m5gfx::i2c::writeRegister8(i2c_port, aw9523_i2c_addr, 0x05, 0b00001100);  // CONFIG_P1 OUT[0]/IN[1]
            m5gfx::i2c::bitOn(i2c_port, aw9523_i2c_addr, 0x02, 0b00000101); //P0 OUTPUT_CTRL
            m5gfx::i2c::bitOn(i2c_port, aw9523_i2c_addr, 0x03, 0b00000011); //P1 OUTPUT_CTRL
            // m5gfx::i2c::writeRegister8(i2c_port, aw9523_i2c_addr, 0x06, 0b11111111);  // INTEN_P0 TF_DETECT ES7210 EN[0] DIS[1]
            // m5gfx::i2c::writeRegister8(i2c_port, aw9523_i2c_addr, 0x07, 0b11111111);  // INTEN_P1 AW88298   FT6336 EN[0] DIS[1]
            m5gfx::i2c::writeRegister8(i2c_port, aw9523_i2c_addr, 0x11, 0b00010000);  // GCR P0 port is Push-Pull mode.
            m5gfx::i2c::writeRegister8(i2c_port, aw9523_i2c_addr, 0x12, 0b11111111);  // GPIOMODE_P0
            m5gfx::i2c::writeRegister8(i2c_port, aw9523_i2c_addr, 0x13, 0b11111111);  // GPIOMODE_P1
